...
const errors = {
  ...
  noInfoCreateState: {code: ++cont, message: 'A new state need at least a prev_state_id, value, user_id, remote_id, remote_collection, field_name'},
  ...
  userExist: {code: ++cont, message: 'This user already exist'},
   
  existentVisit: {code: ++cont, message: 'There is already a visit with this sheet'},
  noInfoCreateVisit: {code: ++cont, message: 'A new visit should have at least sheetId'}
}
module.exports = {
