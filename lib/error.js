...
const errors = {
  ...
  noInfoCreateState: {code: ++cont, message: 'A new state need at least a prev_state_id, value, user_id and sheet_id'},
  ...
  noInfoCreateVisit: {code: ++cont, message: 'A new visit should have at least sheetId and userId'}
}
module.exports = {
